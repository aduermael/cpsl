...
- [x] 2d: Add tests for paste collapsing — test paste detection (above/below threshold), message struct creation, viewport rendering of collapsed vs normal messages, paste counter incrementing, and config threshold respected.
