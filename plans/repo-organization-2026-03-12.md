...
- [ ] 3a: Create prompt template files in `prompts/` directory — one file per section (role.md, tools.md, practices.md, communication.md, skills.md, environment.md) plus a master template that includes them
