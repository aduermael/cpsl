...
type PromptData struct {
	...
	Personality    string
	Skills              []Skill
	ProjectInstructions string // content from .herm/instructions.md, injected as-is
...
func buildSystemPrompt(tools []Tool, serverTools []types.ToolDefinition, skills []Skill, workDir string, personality string, projectInstructions string, containerImage string, worktreeBranch string, snap *projectSnapshot) string {
...
func buildSubAgentSystemPrompt(tools []Tool, serverTools []types.ToolDefinition, workDir string, projectInstructions string, containerImage string, snap *projectSnapshot) string {
	toolNames := make(map[string]bool)
	var hostTools []string
	for _, t := range tools {
		name := t.Definition().Name
